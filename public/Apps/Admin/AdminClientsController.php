...
class AdminClientsController {
	...
	public function deleteClient(Request $request, Response $response, $args){
		...
		// Delete all client-structures associations from clients_structures
		$deleteClientStructures = "DELETE FROM clients_structures WHERE idClient = :idClient ";
		$deleteClientStructuresResult = $this->container->db->query($deleteClientStructures, $datas);
		return $response->withStatus(200)
